package net
{
	...
	public class BallBattleServer
	{
		...
		{ 
			...
			serverSocket.listen();
			addText(" wait connect...");
		}
		
		private function onError(e:IOErrorEvent):void{
			addText("connect error..." + e.toString());
		}
		...
		protected function onSocketData(e:ProgressEvent):void{
			...
			if(clientEntry.handshakeDone){
				...
				try{
					...
					addText("rev json is 无效");
					return;
				}
				socketHand.onSocketData(json, socket);
			}else{
				addText("开始握手");
		...
		public function setSocketHand(hand:ISocketHand):void{
			this.socketHand = hand;
		}
