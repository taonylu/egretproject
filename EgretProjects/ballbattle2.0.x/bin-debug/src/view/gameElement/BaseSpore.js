...
var BaseSpore = (function (_super) {
    ...
    var __egretProto__ = BaseSpore.prototype;
    ...
    __egretProto__.moveTo = function (targetX, targetY) {
    ...
    __egretProto__.moveToByAngle = function (angle) {
        if (angle <= Math.PI) {
    ...
    __egretProto__.setSkin = function (skinID) {
        this.skinID = skinID;
        this.skin.texture = RES.getRes("monster" + skinID + "_png");
        this.setSize();
    };
    __egretProto__.eat = function (weight) {
        this.weight += weight;
    ...
    __egretProto__.tuPaoPao = function () {
    ...
    __egretProto__.fenLie = function () {
    ...
    __egretProto__.moveFrom = function (xPos, yPos, angle) {
...
BaseSpore.prototype.__class__ = "BaseSpore";
