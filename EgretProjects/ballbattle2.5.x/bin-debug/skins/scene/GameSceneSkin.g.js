...
(function (skins) {
    ...
    (function (scene) {
        var GameSceneSkin = (function (_super) {
            ...
            var d = __define,c=GameSceneSkin;p=c.prototype;
            d(p, "skinParts"
                ,function () {
            ...
            p.topLabel_i = function () {
                var t = new egret.gui.Label();
                this.topLabel = t;
                this.__s(t, ["size", "textAlign", "verticalAlign", "width", "x", "y"], [15, "center", "middle", 496, 155, 8]);
                return t;
            };
            p.tupaopaoBtn_i = function () {
                var t = new NarrowButton();
                this.tupaopaoBtn = t;
                this.__s(t, ["skinName", "x", "y"], [skins.ui.TuPaoPaoSkin, 623, 368]);
                return t;
            };
            p.weightLabel_i = function () {
                var t = new egret.gui.Label();
                this.weightLabel = t;
                this.__s(t, ["fontFamily", "size", "text", "textColor", "touchChildren", "touchEnabled", "width", "x", "y"], ["宋体", 18, "体重：10毫克", 0xF6F0F0, false, false, 190, 7, 157]);
                return t;
            };
        ...
        egret.registerClass(GameSceneSkin,"skins.scene.GameSceneSkin");
