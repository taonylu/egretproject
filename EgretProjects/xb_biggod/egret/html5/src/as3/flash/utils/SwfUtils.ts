...
class SwfUtils
{
    ...
    private static illegalNameChars = ['.','-','~','*','(',')','!','\''];
    // 链接类模板 - 动态生成链接类
    public static symbolTemplate:string = '';
    public static bitmapDataTemplate:string = '';
    public static buttonTemplate:string = '';
    public static soundTemplate:string;
     ...
     */
    public static getDefName(resModule:string, defName:string):string {
        var fullName:string = resModule + '_' + defName;
