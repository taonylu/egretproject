...
(function (egret) {
    var SwfMovie = (function (_super) {
        ...
        __egretProto__.init = function (conf, symbolName, id) {
            if (conf === void 0) { conf = null; }
            if (symbolName === void 0) { symbolName = ""; }
            if (id === void 0) { id = -1; }
        ...
        __egretProto__.$recycleInnerObj = function (obj) {
            ...
            if (obj["__type_name"] == "egret.SwfSprite") {
                var result = egret.SwfRes.Pool_recycle(egret.SwfRes.PoolName_Common, null, obj, "egret.SwfSprite");
            }
            else if (obj["__type_name"] == "egret.Sprite") {
                var result = egret.SwfRes.Pool_recycle(egret.SwfRes.PoolName_Common, null, obj, "egret.Sprite");
            }
            ...
            else if (obj instanceof egret.SwfMovie) {
        ...
        __egretProto__.$addShape = function (def, parantSP, po) {
            ...
            if (null != this.$curFrameObjs[po.depth]) {
                ...
                shapeContainer = egret.SwfRes.Pool_getByID(egret.SwfRes.PoolName_Common, null, "egret.Sprite");
        ...
        __egretProto__.$addSprite = function (defsp, parantSP, po) {
            ...
            if (null != this.$curFrameObjs[po.depth]) {
                ...
                mc = egret.SwfRes.Pool_getByID(this.conf.path, this.conf, defsp.id);
        ...
        __egretProto__.$placeObjects = function (datas, parantSP, frame) {
            ...
            if (null == parantSP) {
                ...
                parantSP = egret.SwfRes.Pool_getByID(egret.SwfRes.PoolName_Common, null, "egret.SwfSprite");
            }
