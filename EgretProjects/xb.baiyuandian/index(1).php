...
<head>
    ...
    <!--game_files_start-->
    <script src="/byd/main.min.js?ver=2.11"></script>
    <!--game_files_end-->
</head>
<body>
...
<!--
<audio id="bgm" src="/byd/resource/assets/sound/bgm.mp3" preload="auto" loop="loop"></audio>
...
<script>
    ...
    window["sign"] = "";
	window['shareText'] = "小伙伴快进来抽红包，最高可中888.88元!";
