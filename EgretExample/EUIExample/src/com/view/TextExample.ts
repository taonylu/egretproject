 ...
 *
 */
class TextExample extends egret.DisplayObjectContainer{
    ...
    public test(): void {
        ...
        //2 样式，运行不了
        var text2: eui.Label = new eui.Label();
        text2.width = 100;
        text2.height = 50;
        text2.x = 100;
        text2.y = 0;
        ...
        text3.width = 200;
        text3.height = 200;
        text3.textFlow = (new egret.HtmlTextParser).parser(
            '没有任何格式初始文本，' +
        ...
        text4.textFlow = new Array<egret.ITextElement>(

            { text: "这段文字有链接",style: { "href": "http://www.baidu.com" } }
        ...
        text4.addEventListener(egret.TextEvent.LINK,function(): void {
            console.log("点击文本");
            },this);
        this.addChild(text4);
        ...
        //5 聊天框滚动
        var text5: eui.Label = new eui.Label();
        text5.width = 200;
        text5.height = 200;
        text5.x = 0;
        text5.y = 300;
