package
{
	...
	public class DemoGetAABB extends AbstractBox2DTest
	{
		public function DemoGetAABB()
		{
			super(5);
		...
		private var p1:b2Vec2 = new b2Vec2(), p2:b2Vec2 = new b2Vec2(500/30);
		private var HighestY:Number;
		private var red:b2Color = new b2Color(1,0,0);
		
		private function drawHighestLine():void
		{
			HighestY = 500/30;
			var b:b2Body = world.GetBodyList().GetNext();
			while(b){
				if (b.GetType() == b2Body.b2_dynamicBody) 
				{
					ab = getAABBOfBody(b);
					HighestY = Math.min(ab.lowerBound.y,HighestY);
				}
				b = b.GetNext();
			}
		...
		{
			var combineAB:b2AABB = new b2AABB();
