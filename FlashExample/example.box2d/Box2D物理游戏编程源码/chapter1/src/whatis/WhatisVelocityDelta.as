package whatis
{
	...
	public class WhatisVelocityDelta extends Sprite
	{
//		[SWF(width="500",height="450",frameRate="2")]
		...
		public function WhatisVelocityDelta()
		{
		...
		protected function loop(event:Event):void
		{
			...
			if(isPositionDelta){
				...
				tip.text = "velocityDelta=1";
			}else{
				LDEasyWorld.stepVelocityDelta=10;
				tip.text = "velocityDelta=10";
			}
