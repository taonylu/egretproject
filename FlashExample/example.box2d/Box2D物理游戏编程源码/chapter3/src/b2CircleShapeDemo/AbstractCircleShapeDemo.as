package b2CircleShapeDemo {
	 ...
	 * @author yangfei
	 */
	public class AbstractCircleShapeDemo {
		public var debug : b2DebugDraw;
		public var box2DWorld:b2World;
		public var debugSprite:Sprite;
		
		public function AbstractCircleShapeDemo(gravity:Number=10) {
			debugSprite = Whatisb2CircleShape.debugSprite;
		...
		{
			Whatisb2CircleShape.title.text = title;
			Whatisb2CircleShape.funTxt.text=fun;
			Whatisb2CircleShape.tipTxt.text+=tip;
		}
		public function editValueText(value:String):void
		{
			Whatisb2CircleShape.valueTxt.text=value;
		}
...
//					var body:b2Body = LDEasyWorld.getBodyAtMouse();
//					if(body!=null){
